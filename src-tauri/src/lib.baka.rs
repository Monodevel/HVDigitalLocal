...
pub fn run(){
    let migrations = vec![
        Migration {
            version: 1,
            description: "creat_tablas_iniciales",
            sql: r#"
        ...
        Migration {
            ...
            sql: include_str!(
                "../migrations/002_catalogos_normativos.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/003_grados_calidades.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/004_factores_normativos.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/005_catalogo_anotaciones.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/006_motor_plantillas_anotacion.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/007_puntajes_y_efectos_anotaciones.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/008_personas_hojas_vida_anotaciones.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/009_vincular_borrador_anotacion.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/011_configuracion_inicial.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/012_designaciones_expedientes.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/013_panel_periodo.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/014_expediente_detalle.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/015_hoja_vida_operativa.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
        ...
        Migration {
            ...
            sql: include_str!(
                "../migrations/018_formato_oficial_evint.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            sql: include_str!(
                "../migrations/020_corregir_escala_calculo_evint.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            description: "corregir_escala_y_calculo_evint",
            sql: include_str!(
                "../migrations/021_hoja_vida_cronologica.sql"
            ),
            kind: MigrationKind::Up,
        },
        Migration {
            ...
            description: "corregir_escala_y_calculo_evint",
            sql: include_str!(
                "../migrations/022_resoluciones_anotaciones_libres.sql"
            ),
            kind: MigrationKind::Up,
        },
    ];
    ...
    tauri::Builder::default()
        ...
        .setup(|app|{
            let menu_aplicacion = SubmenuBuilder::new(
                    app,"HVDigital",
                ).text(
                    "menu_acerca",
                    "Acerca de HVDigital",
            ...
            let menu_expediente =
                ...
                .text(
                    "menu_expediente_actual",
                    "Abrir expediente actual",
                )
                .text(
                    "menu_hoja_vida",
                    "Hoja de Vida",
            ...
            let menu_anotaciones =
                SubmenuBuilder::new(
                    app,
                    "Anotaciones",
                )
                .text(
                    "menu_nueva_anotacion",
                    "Nueva anotación",
                )
                .text(
                    "menu_ver_hoja_vida",
