/*
 * MIGRACIÓN OBSOLETA — NO REGISTRAR NI EJECUTAR.
 *
 * Esta propuesta inicial utilizaba las columnas:
 *   - descriptores_aplicables
 *   - descriptores_evaluados
 *   - descriptores_no_observados
 *   - nota_promedio
 *
 * Fue reemplazada por 020_corregir_escala_calculo_evint.sql, que crea la
 * estructura definitiva utilizada por los servicios actuales:
 *   - total_descriptores
 *   - total_evaluados
 *   - total_no_observados
 *   - nota_evint
 *
 * Se conserva únicamente como referencia histórica. El registro activo de
 * migraciones se encuentra en src-tauri/src/lib.rs.
 */
